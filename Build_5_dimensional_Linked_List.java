...
public class Build_5_Dimensional_Linked_List {
	...
	public Build_5_Dimensional_Linked_List() {
		...
		five_dimensional_linked_list_X_A = new LinkedList<Double>();
...
//   /*
		...
		public void Build(int _1st_d_X_B, int _2nd_d_X_C, int _3rd_d_X_C_Two, int _4th_d_X_D,
			...
			int total_nodes = (_1st_d_b_X_J * _2nd_d_b_X_I  *
					_3rd_d_b_X_H * _4th_d_b_X_G * _5th_d_b_X_F) +
					anti_buffer_breach_one_hundred_nodes;
	...
	//		int total_nodes = 
			...
			for(int i = 1; i <= total_nodes;i++) {
				...
				five_dimensional_linked_list_X_A.add(null);
		...
		//	*/
		/*	
		public void build_3d(int _1st_d, int _2nd_d, int _3rd_d) {
			
			int total_3d_nodes_plus_one_hundred =  
					_1st_d + _2nd_d +  _3rd_d + 100;
